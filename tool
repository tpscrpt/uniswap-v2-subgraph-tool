...
const stripAnsi = __webpack_require__(637);
const isFullwidthCodePoint = __webpack_require__(770);
...
const ansiRegex = __webpack_require__(381);
...
const { dirname, resolve } = __webpack_require__(17);
const { readdirSync, statSync } = __webpack_require__(147);
...
var fs = __webpack_require__(147),
  join = (__webpack_require__(17).join),
  resolve = (__webpack_require__(17).resolve),
  dirname = (__webpack_require__(17).dirname),
  defaultOptions = {
...
const stringWidth = __webpack_require__(457);
const stripAnsi = __webpack_require__(368);
const ansiStyles = __webpack_require__(629);
...
const makeDynamicStyles = (wrap, targetSpace, identity, isBackground) => {
	if (colorConvert === undefined) {
		colorConvert = __webpack_require__(722);
	}
...
const cssKeywords = __webpack_require__(509);
...
const conversions = __webpack_require__(833);
const route = __webpack_require__(42);
...
const stripAnsi = __webpack_require__(368);
const isFullwidthCodePoint = __webpack_require__(55);
const emojiRegex = __webpack_require__(809);
...
const ansiRegex = __webpack_require__(800);
...
const stripAnsi = __webpack_require__(679);
const isFullwidthCodePoint = __webpack_require__(697);
const emojiRegex = __webpack_require__(809);
...
const ansiRegex = __webpack_require__(413);
...
const stringWidth = __webpack_require__(792);
const stripAnsi = __webpack_require__(637);
const wrap = __webpack_require__(152);
function ui(opts) {
    return cliui(opts, {
        stringWidth,
        stripAnsi,
...
const parser = new YargsParser({
    ...
    require: (path) => {
        if (true) {
            return __webpack_require__(670)(path);
        }
        else {}
    }
});
...
const {Yargs, processArgv} = __webpack_require__(261);
...
function Argv(processArgs, cwd) {
  const argv = Yargs(processArgs, cwd, __webpack_require__(907));
  singletonify(argv);
...
/******/ 	var __webpack_exports__ = __webpack_require__(__webpack_require__.s = 220);
/******/ 	
/******/ })()
;